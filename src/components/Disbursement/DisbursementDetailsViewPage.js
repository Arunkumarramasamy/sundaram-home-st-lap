...
const DisbursementDetailsViewPage = (props) => {
  ...
  const getDetailPageData = async (record, mode) => {
    ...
    const response1 = await losCustomerApi.post("/getCustBankDetailsByAppNum",{"applicationNum": detailPageInitialState.applicationNum});
    ...
    const response2 = await losCustomerApi.post("/getCustomerDataByAppNum",{"applicationNum": detailPageInitialState.applicationNum});
